...
O **Cuida Pet** é um **aplicativo web** desenvolvido como projeto da disciplina **Front-End Frameworks**, do curso de **Análise e Desenvolvimento de Sistemas** da **UNINASSAU Caruaru (Turma B / Noite / Presencial)**.
...
| 🗄️ Banco de Dados | **Firebase / Supabase (planejado)** |
| 🖌️ Design | **Figma** |
